		...
		map[string]interface{}{
			"ticketForm": htmlutil.CreateTemplateToString(
				...
				map[string]interface{}{
					...
					"stock":     result.TicketInfo.Stock,
					"startTime": result.TicketInfo.StartTime,
					"endTime":   result.TicketInfo.EndTime,
				},
			),
		},
		[]string{
...
func CreateTicket(w http.ResponseWriter, r *http.Request) {
	...
	TicketRpcService.CreateTicket(ctx, mid, txTime,
		ticketInfo.EventId, ticketInfo.TicketId,
		ticketInfo.Name, ticketInfo.Price,
		ticketInfo.Desc, ticketInfo.Stock,
		startTime, endTime,
	)
...
func UpdateTicket(w http.ResponseWriter, r *http.Request) {
	...
	TicketRpcService.UpdateTicket(ctx, mid, txTime, req.EventId, req.TicketInfo)
