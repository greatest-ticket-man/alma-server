...
class EventCreate {
    ...
    addMemberToTable() {
        ...
        row.insertCell(5).innerHTML = `<button class="input-container__email-table__delete-button  material-icons" onclick="eventCreate.deleteMemberToTable(this);"'>delete</button>`;
...
const eventCreate = new EventCreate();
